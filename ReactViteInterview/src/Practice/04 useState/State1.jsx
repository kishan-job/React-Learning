// useState hook in react is a function which is used to manage the state in the fucnitonal component. By using the useState hook we can update the compoent content dynamically. useState hook returns an array which have state variable and updating funtion.
...
function State1() {
  ...
  return (
    <div>
      ...
      <button onClick={(e) => setCar({ ...car, color: "blue" })}>
        {" "}
        Change to blue
      </button>
